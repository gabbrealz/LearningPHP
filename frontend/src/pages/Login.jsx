    ...
    <section className="w-full h-screen px-4 flex justify-center items-center">
      <form className="bg-gray-100 w-100 border-2 rounded-xl px-12 py-6 flex flex-col items-center gap-4">
        ...
        <div className="w-4/5 flex flex-col mt-4">
          <input type="submit" id="login-submit" value="Login" className="w-full text-white bg-black mb-2 border py-1 rounded-md cursor-pointer hover:bg-gray-800 transition-colors" />
